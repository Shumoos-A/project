  ...
  return (
    <footer className="bg-white text-black border-t border-gray-200">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1 space-y-4">
            <div className="flex items-center space-x-2">
              <div className="bg-black text-white font-bold text-lg rounded-md w-7 h-7 flex items-center justify-center">
                E
              </div>
            ...
            {/* ✅ النص الذي أضفته تحت الشعار */}
            <p className="text-sm text-gray-600">
              Discover your style. Elevate your space. Your destination for modern elegance.
            </p>
          ...
          <div className="md:col-span-1">
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/products/fragrances" className="text-black hover:text-gray-600 transition">Fragrances</Link></li>
        ...
        <div className="mt-8 pt-8 border-t border-black text-center text-sm text-gray-600">
