    ...
    <div className="mt-12">
      ...
      <form onSubmit={handleSubmitReview} className="bg-white p-6 rounded-xl shadow-md mb-8 space-y-4">
        ...
        <div>
            ...
            <input id="authorName" type="text" value={authorName} onChange={e => setAuthorName(e.target.value)} placeholder="e.g. Shumoos Ali" required className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"/>
        </div>
        <div>
        ...
        <button type="submit" className="px-6 py-2 bg-gray-800 text-white rounded-lg font-semibold hover:bg-gray-700 transition">Submit Review</button>
      </form>
